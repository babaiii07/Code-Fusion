...
export const LoginModal = ({
  ...
  html,
  onClose,
  title = "Log In to use CodeFusion for free",
  description = "Log In through your Hugging Face account to continue using CodeFusion and increase your monthly free limit.",
}: {
  open: boolean;
  html?: string;
