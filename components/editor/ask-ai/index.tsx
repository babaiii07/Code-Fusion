      ...
      <div className="relative bg-neutral-800 border border-neutral-700 rounded-2xl ring-[4px] focus-within:ring-neutral-500/30 focus-within:border-neutral-600 ring-transparent z-10 w-full group">
          ...
          <div className="w-full border-b border-neutral-700 relative overflow-hidden">
            ...
            >
              <p className="text-sm font-medium text-neutral-300 group-hover:text-neutral-200 transition-colors duration-200">
                {isThinking ? "CodeFusion is thinking..." : "CodeFusion's plan"}
              </p>
              <ChevronDown
        ...
        <div className="w-full relative flex items-center justify-between">
          ...
          <input
            ...
            placeholder={
              selectedElement
                ? `Ask CodeFusion about ${selectedElement.tagName.toLowerCase()}...`
                : hasAsked
                ? "Ask CodeFusion for edits"
                : "Ask CodeFusion anything..."
            }
            value={prompt}
          ...
          <div className="flex-1 flex items-center justify-start gap-1.5">
            ...
            {!isSameHtml && (
              <Tooltip>
                ...
                >
                  Select an element on the page to ask CodeFusion edit it
                  directly.
                </TooltipContent>
              </Tooltip>
            )}
