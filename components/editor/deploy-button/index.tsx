    ...
    <div className="flex items-center justify-end gap-5">
      <div className="relative flex items-center justify-end">
            ...
            >
              <header className="bg-neutral-50 p-6 border-b border-neutral-200/60">
                ...
                <p className="text-sm text-neutral-500 mt-1.5">
                  Deploy your project to a Space on the Hub. Spaces are
        ...
        <LoginModal
          ...
          html={html}
          title="Log In to deploy your Project"
          description="Log In through your Hugging Face account to deploy your project and increase your monthly free limit."
        />
      </div>
    </div>
  );
